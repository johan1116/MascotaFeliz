...
namespace MascotaFeliz.App.Persistencia.AppRepositorios
{
...

    {
        ...
        public VisitaDomiciliaria Add(VisitaDomiciliaria nuevaVisita)
        {
            nuevaVisita.Id=visitadomiciliarias.Max(nv => nv.Id)+1;
            visitadomiciliarias.Add(nuevaVisita);
            return nuevaVisita;
        }
        ...
        public VisitaDomiciliaria Update(VisitaDomiciliaria visitaActualizada)
        {
            var visita = visitadomiciliarias.SingleOrDefault(r => r.Id == visitaActualizada.Id);
            if (visita != null)
            {
